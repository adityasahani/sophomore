...
for($x=0; $x<6; $x++)
{
if (($sem2[$x]['subject']!=$backlog1) && ($sem2[$x]['subject']!=$backlog2) && ($sem2[$x]['subject']!=$backlog3) && ($sem2[$x]['subject']!=$backlog4) && ($sem2[$x]['subject']!=$unchecked1) && ($sem2[$x]['subject']!=$unchecked2) && ($sem2[$x]['subject']!=$unchecked3) && ($sem2[$x]['subject']!=$unchecked4))
{
    echo '<table class="a" align="center" border="1">';
	echo '<tr>';
	echo '<td>';
	...
	echo '<td>';
	echo '<h4>';
    echo $sem2[$x]['subject_code'];
	echo '</h4>';
	echo '</td>';
	echo '<td>';
	echo '<h4>';
    echo $sem2[$x]['semester'];
	echo '</h4>';
	echo '</td>';
	echo '<td>';
	echo '<h4>';
...
if($stusemester<2)
{
	echo "<script type='text/javascript'>alert('You have not appeared for the 2nd semester yet!!!')</script>";
}
else
{
}
